...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="relative flex h-208 items-center justify-center p-2 md:h-256 md:p-20"
      ref={containerRef}
    >
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="mx-auto -mt-12 h-120 w-full max-w-5xl rounded-[30px] border border-white/10 background-gradient-to-br text-white p-2 shadow-2xl backdrop-blur-xl md:h-160 md:p-4"
    >
